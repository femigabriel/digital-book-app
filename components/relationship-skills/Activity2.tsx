    ...
    <div className="relationship-skill w-full h-screen bg-[#ECE0F5]">
      <div className=" bg-[#ECE0F5] w-full max-w-[750px] rounded-[10px] shadow-xl ">
        <div className="px-5 py-5">
          ...
          <div className="mt-3">
            <p className="text-sm">2. Charlie held Mya as she cried on her shoulder. The school bus driver walked over and asked a question. “Are you girls okay?”</p>
       <div className="lg:flex gap-3 w-full mt-3">
        <span className="text-sm font-semibold">The bus driver is showing</span>
        <input type="text"  className="w-full max-w-[450px] bg-inherit border border-[#303030] border-x-0 border-t-0"/>
       </div>
          </div>
